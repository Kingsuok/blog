...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">HOME</a> &raquo;  All Links
    </div>
    <!--面包屑导航 结束-->
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <a href="{{url('admin/link')}}"><i class="fa fa-refresh"></i>Refresh Links</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>{{$v['link_description']}}</td>
                        <td>{{$v['link_url']}}</td>
                        <td>
                            <a href="{{url('admin/link/'.$v['link_id'].'/edit')}}">EDIT</a>
                            <a href="javascript:;" onclick="deleteConfirm({{$v['link_id']}})">DELETE</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
    ...
    <script>
        ...
        function changeOrder(object, sID) {
            ...
            $.post("{{url('admin/link/changeorder')}}",
                {'_token':'{{csrf_token()}}','link_id':sID, 'link_order':order},
                function (aData) {
                   if (aData.status){
        ...
        //询问框
        function deleteConfirm(sLink_id){
            layer.confirm('Are you sure？', {
                btn: ['Yes','No'] //按钮
            }, function(){
                $.post("{{url('admin/link')}}/"+sLink_id,
