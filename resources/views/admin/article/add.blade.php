...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">Home</a> &raquo; Add New Article
</div>
<!--面包屑导航 结束-->
    ...
    <form action="{{url('admin/article')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>THUMB：</th>
                <td>
                    <input type="text" class="lg" name="art_thumb" disabled>
                    <input id="file_upload" name="file_upload" type="file" multiple="true">
                    <img id="art_thumb_img" src="" style="max-width: 350px; max-height: 100px;">
